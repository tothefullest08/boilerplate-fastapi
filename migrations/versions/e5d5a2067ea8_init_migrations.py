...
Revision ID: e5d5a2067ea8
Revises: 
Create Date: 2023-08-09 12:27:19.739318
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "name_chosung", sa.String(length=64), nullable=False, comment="이름 초성"
        ),
        ...
        sa.Column(
            "size", sa.String(length=32), nullable=False, comment="사이즈 (small or large)"
        ),
        sa.Column("expiration_date", sa.DateTime(), nullable=False, comment="유통기한"),
    ...
    op.create_table(
        ...
        sa.Column("user_id", sa.Integer(), nullable=False),
        sa.Column(
            "access_token", sa.String(length=256), nullable=False, comment="액세스 토큰"
        ),
        sa.Column(
            "refresh_token", sa.String(length=256), nullable=False, comment="리프레시 토큰"
        ),
        sa.Column("created_at", sa.DateTime(), nullable=False),
        sa.Column("updated_at", sa.DateTime(), nullable=False),
        sa.PrimaryKeyConstraint("id"),
    ...
    op.create_index(
        op.f("ix_user_tokens_user_id"), "user_tokens", ["user_id"], unique=True
    )
    op.create_table(
        "users",
        sa.Column(
        ...
        sa.Column(
            "phone_number", sa.String(length=32), nullable=False, comment="핸드폰 번호"
        ),
...
def downgrade() -> None:
    ...
    op.drop_index("products_user_id_name_name_chosung_idx", table_name="products")
